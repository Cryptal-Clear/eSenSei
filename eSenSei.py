...
email_id = "Sender's email id"
password = "Sender's email password"
toadr = "Receiver's email id"
...
time_iter = #Enter the time duration for which you want your code to run in a single instance. 
no_of_iter_end = #Enter the no of times you want the code to run.
a = 0
sub = "Activities"
